 ...
 */
class CRM_Eventcheckin_Upgrader_Base {

  /**
   * @var CRM_Eventcheckin_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Eventcheckin_Upgrader(
        'de.systopia.eventcheckin',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Eventcheckin_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Eventcheckin_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
